...
calvin.Create(function () {
    ...
    array.prototype = {
        ...
        *    var copyArray =calvin.Array.copy(initalArray);
        ...
        *@example
        *   var calvinArray = calvin.Array;
        *    var initalArray = [1, 2, 3, 4, 6, 6, 7];
        *   calvinArray.addRange(initalArray, [1, 3, 4]);
        */
        ...
        * var calvinArray = calvin.Array;
        * var initalArray = [1, 2, 3, 4, 6, 6, 7];
        * calvinArray.deleteRepeater(initalArray);
        */
        ...
        * var calvinArray = calvin.Array;
        * var initalArray = [1, 2, 3, 4, 6, 6, 7];
        *calvinArray.forEach(initalArray, function (data, index) {
        ...
        * var calvinArray = calvin.Array;
        * var initalArray = [1, 2, 3, 4, 6, 6, 7];
        *  var filterArray = calvinArray.filter(initalArray, function ( data,index) {
        ...
        * var calvinArray = calvin.Array;
        * var initalArray = [1, 2, 3, 4, 6, 6, 7];
        *    console.log(calvinArray.map(initalArray, function (data, index) {
        *       return data + index;
        *    }));
        */
